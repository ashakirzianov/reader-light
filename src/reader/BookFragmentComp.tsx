...
import {
    ...
    RichTextAttrs, Color, Path, RichText, RichTextSelection,
} from './RichText';
...
function bookPathForBlockPath(blockPath: Path, data: BlockData): BookPath | undefined {
...
function blockPathForBookPath(path: BookPath, data: BlockData): Path | undefined {
...
function buildBlocksData(fragment: BookFragment, env: BuildBlocksEnv) {
